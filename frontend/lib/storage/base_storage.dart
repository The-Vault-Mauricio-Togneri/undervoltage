...
class Storage {
  ...
  static Future<List<String>> getStringList(String field, List<String> defaultValue) async {
    final SharedPreferences preferences = await _preferences();
  ...
  static Future<SharedPreferences> _preferences() async => SharedPreferences.getInstance();
}
